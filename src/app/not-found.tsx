    ...
    >
      <section className="container h-full py-12 px-4 flex justify-center place-items-center md:justify-end md:place-items-end">
        <div className="max-w-[600px] md:w-[600px] flex flex-col">
          <h1 className="text-iBlue font-avenirBlack text-9xl text-center mb-10">
            404
          </h1>
          <h2 className="text-black font-avenirNextRegular text-6xl text-center">
            Page Not Found
          </h2>
          <p className="max-w-[600px] text-center text-2xl text-black font-avenirRoman mt-6">
