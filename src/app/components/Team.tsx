  ...
  return (
    <Card className="flex flex-row p-0">
      ...
      <CardContent className="p-6 flex place-items-center">
        <div>
          <div className="[&_h4]:text-iBlue [&_h4]:font-avenirNextBold [&_h4]:text-lg [&_h4]:mb-2 [&_h5]:text-base [&_h5]:text-iBlue [&_h5]:font-avenirRoman">
            <h4>Full Names</h4>
            <h5>Designation</h5>
          </div>
          <ul className="flex flex-row max-w-[300px] mx-auto my-6 md:ml-0 gap-8 justify-between [&_li]:w-[24px] [&_li]:h-[24px] [&_li]:border-1 [&_li]:border-iSecondary [&_li]:rounded-md">
